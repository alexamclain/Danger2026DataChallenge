// P27 B-line reduced cover q7 localized reduced/irreducible smoke.
//
// Degree(S) is too heavy or unsupported on the localized chart.  This fixture
// asks only IsReduced and IsIrreducible after the dimension check.
...
print "BREDUCED_LOCALIZED_REDUCED_START", q, Dimension(S), #Basis(J);

try
    print "BREDUCED_LOCALIZED_REDUCED_ISREDUCED", IsReduced(S);
catch e
    print "BREDUCED_LOCALIZED_REDUCED_ISREDUCED_ERROR";
end try;

try
    print "BREDUCED_LOCALIZED_REDUCED_ISIRREDUCIBLE", IsIrreducible(S);
catch e
    print "BREDUCED_LOCALIZED_REDUCED_ISIRREDUCIBLE_ERROR";
end try;

print "RESULT p27_b_line_reduced_cover_localized_reduced_q7 done";
